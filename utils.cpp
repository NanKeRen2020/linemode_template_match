...
Linemode_Template_Match::Linemode_Template_Match(const std::vector<int>& pyr_stride, const std::vector<float>& angle_range, float angle_step, 
                    ...
                    m_pyr_stride(pyr_stride), m_angle_range(angle_range), m_angle_step(angle_step), 
                    m_scale_range(scale_range), m_scale_step(scale_step),
...
Linemode_Template_Match::Linemode_Template_Match(int feature_number, const std::vector<int>& pyr_stride, const std::vector<float>& angle_range, 
                     float angle_step, const std::vector<float>& scale_range, float scale_step, const std::string& model_path, 
                     const std::vector<std::string>& class_ids, const std::string& template_model_name,
...
void Linemode_Template_Match::load_model(const std::string& model_path, const std::vector<std::string>& class_ids, 
...
bool Linemode_Template_Match::train_model(const cv::Mat& template_image, const std::string& model_path, 
                                          const std::string& class_id, const std::string& template_model_name)
{
    ...
    m_shapes.save_infos(infos_have_templ, model_path + class_id  + "_" + template_model_name + "_infos.yaml");
...
bool Linemode_Template_Match::train_model(const std::string& template_image_path, const std::string& model_path, 
                                          const std::string& class_id, const std::string& template_model_name)
{
    // 删除已有模板
    delete_model({class_id});
